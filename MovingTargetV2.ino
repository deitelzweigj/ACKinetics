...
float accel       = 0.0125;    // works with 0.6 accel and 40 minDelay
int   maxPosition = 18000;   // maximum position stage can travel
...
void loop(){
  ...
  int moveAmount = (goalPos - currPos);        // error in position. TODO: replace goalPos with arrayAvg
  int dirToMove  = (moveAmount >=0 ) ? 0:1;    // pick direction
